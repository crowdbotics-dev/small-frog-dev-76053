"""
Django settings for small_frog_dev_76053 project.
...
ROOT_URLCONF = 'small_frog_dev_76053.urls'
...
WSGI_APPLICATION = 'small_frog_dev_76053.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "small_frog_dev_76053 API",
    "DESCRIPTION": "API documentation for small_frog_dev_76053 App",
    "VERSION": "v1",
}
